            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // License / Registration Number (رقم مزاولة المهنة)
                  _buildValidatedField(
                  ...
                  GestureDetector(
                    onTap: () async {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text(
                            '📎 Connect file_picker package to enable uploads',
                          ),
